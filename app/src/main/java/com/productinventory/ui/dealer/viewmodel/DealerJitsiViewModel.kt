...
import com.productinventory.ui.dealer.model.videocall.DealerCallList
...
@HiltViewModel
class DealerJitsiViewModel @Inject constructor(
                ...
                when {
                    snapshot!!.isEmpty -> {
                        ...
                        for (dc in snapshot.documents) {
                            val callModel = DealerCallList.getCallList(dc)
